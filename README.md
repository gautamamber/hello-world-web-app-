...
My new hello world app using django-init
...
In your terminal, type or copy-paste the following:
    ...
    git clone git@github.com:gautamamber/hello-world-app-web.git; cd hello-world-app-web; fab init
...
## How to release Hello-world-app

"""Django settings for Hello-world-app project.
...
APPS_DIR = ROOT_DIR.path('hello_world_app')
...
# ------------------------------------------------------------------------------
REST_FRAMEWORK = {
    'DEFAULT_PAGINATION_CLASS': 'hello_world_app.base.api.pagination.PageNumberPagination',
    'PAGE_SIZE': 30,
    ...
    'DEFAULT_AUTHENTICATION_CLASSES': (
        ...
        'hello_world_app.users.auth.backends.UserTokenAuthentication',

        # Mainly used for api debug.
        'rest_framework.authentication.SessionAuthentication',
    ),
    'EXCEPTION_HANDLER': 'hello_world_app.base.exceptions.exception_handler',
}
...
SITE_NAME = env("SITE_NAME", default='Hello-world-app')
...
FRONTEND_SITE_NAME = env('FRONTEND_SITE_NAME', default='Hello-world-app')
...
DEFAULT_FROM_EMAIL = env('DEFAULT_FROM_EMAIL',
                         default='amber@nickelfox.com')
EMAIL_SUBJECT_PREFIX = env('EMAIL_SUBJECT_PREFIX', default='[Hello-world-app] ')
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            ...
            'context_processors': [
                'hello_world_app.base.context_processors.site_settings',
...
CSRF_FAILURE_VIEW = 'hello_world_app.base.views.csrf_failure'
...
def get_release():
    ...
    import os
    import raven
    release = hello_world_app.__version__
    try:

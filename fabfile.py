...
#  Settings
# ==========================================================================
env.project_name = 'hello_world_app'
...
def dev():
    ...
    env.remote = 'origin'
    env.branch = 'master'
    env.hosts = ['dev.hello_world_app.com']
    env.dotenv_path = '/home/ubuntu/dev/hello_world_app/.env'
...
def qa():
    ...
    env.remote = 'origin'
    env.branch = 'qa'
    env.hosts = ['qa.hello_world_app.com']
    env.dotenv_path = '/home/ubuntu/qa/hello_world_app/.env'
    env.config_setter = fab.run
...
def prod():
    ...
    env.remote = 'origin'
    env.branch = 'prod'
    env.hosts = ['prod.hello_world_app.com']
    env.dotenv_path = '/home/ubuntu/prod/hello_world_app/.env'
    env.config_setter = fab.run
